...
import com.automation.pages.SearchProductsPage;
...
public class SearchProductsSteps {
    ...
    public void clicks_the_first_brand_under_the_popular_brand_section() {
        searchProductsPage.popularBrand();
    }
